...
from atm.spatracker2.models.SpaTrackV2.models.predictor import Predictor
from atm.spatracker2.models.SpaTrackV2.models.utils import get_points_on_a_grid
from atm.spatracker2.models.SpaTrackV2.models.vggt4track.models.vggt_moe import VGGT4Track
from atm.spatracker2.models.SpaTrackV2.models.vggt4track.utils.load_fn import preprocess_image
from atm.spatracker2.models.SpaTrackV2.models.vggt4track.utils.pose_enc import pose_encoding_to_extri_intri
...
class BCViLTPolicySpaTracker(nn.Module):
    """
    Input: (o_{t-H}, ... , o_t)
    ...
    def _setup_track(self, track_fn, policy_track_patch_size=None, use_zero_track=False):
        ...
        self.vggt4track_model = self.vggt4track_model.to("cuda")

        self.track_model = Predictor.from_pretrained("Yuxihenry/SpatialTrackerV2-Offline")
        self.track_model.spatrack.track_num = 756
        self.track_model.eval()
        self.track_model.to("cuda")
        self.grid_size = 50

        self.num_track_ids = track_cfg.num_track_ids
        self.num_track_ts = track_cfg.num_track_ts
        self.policy_track_patch_size = track_cfg.model_cfg.track_cfg.policy_track_patch_size
    ...
    def track_encode(self, track_obs, task_emb):
        ...
        if self.use_zero_track:
            ...
            with torch.amp.autocast(device_type="cuda", dtype=torch.bfloat16):
                ...
                ) = self.track_model.forward(video_tensor, depth=depth_tensor,
