...
for seed in range(3):
    commond = (f'python -m engine.train_dp --config-name={CONFIG_NAME} train_gpus="{train_gpu_ids}" '
                f'experiment=atm-diffusion-policy_{suite_name.replace("_", "-")}_demo{NUM_DEMOS} '
